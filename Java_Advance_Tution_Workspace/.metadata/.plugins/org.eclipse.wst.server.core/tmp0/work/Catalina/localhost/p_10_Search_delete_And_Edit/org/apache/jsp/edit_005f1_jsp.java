 ...
 * Generated at: 2023-06-07 09:08:58 UTC
...
public final class edit_005f1_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
	...
	ResultSet r=s.executeQuery("SELECT * FROM register WHERE id='"+id+"'");
      ...
      out.write("<form action=\"editIt_1.jsp\">");
	...
	while(r.next()){
      ...
      out.write("<input type=\"text\" name=\"fn\" value=\"");
      out.print(r.getString("firstname"));
      out.write("\"><br><br>");

				
      out.write("<input type=\"text\" name=\"ln\" value=\"");
