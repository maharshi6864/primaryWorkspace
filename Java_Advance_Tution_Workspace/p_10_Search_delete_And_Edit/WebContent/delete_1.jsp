...
<body>
	<%
		...
		int del=0;
		if(id.equals(null)){
			response.sendRedirect("search_1.jsp");
		}
		else{
			del=Integer.parseInt(request.getParameter("id"));
		}
		Class.forName("com.mysql.jdbc.Driver");
		Connection c=DriverManager.getConnection("jdbc:mysql://localhost/db","root","root");
		Statement  s=c.createStatement();
		s.executeUpdate("DELETE FROM register WHERE id='"+del+"'");
		ResultSet r=s.executeQuery("SELECT * FROM register WHERE firstname LIKE '"+search+"%' 	");
