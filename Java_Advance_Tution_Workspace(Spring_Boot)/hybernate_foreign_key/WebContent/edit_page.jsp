	...
	<table border="1px solid black">
		<c:forEach items="${sessionScope.SearchList}" var="i">
			...
			<form action="Rg" method="post">
				...
				<input type="hidden" value="${i.login_id.id }" name="logob">
				...
				username: <input type="text" value="${i.login_id.username}" name="username"><br><br>
				password:<input type="text" value="${i.login_id.password}" name="password"><br><br>
