					...
					<div class="dashboard-header d-flex flex-column grid-margin">
						<div
							...
							<div class="d-flex align-items-center">
								...
								<button
									class="btn btn-inverse-info tx-12 btn-sm btn-rounded mx-3">Enterprise</button>
							...
							<div
								...
								<div class="dropdown mr-3 d-none d-md-block">
									<button
										class="btn btn-sm text-muted border-0 dropdown-toggle px-0"
										type="button" id="dropdownMenuSizeButton2"
										data-toggle="dropdown" aria-haspopup="true"
										aria-expanded="false">UTC time zone</button>
									<div class="dropdown-menu"
										aria-labelledby="dropdownMenuSizeButton2">
										<h6 class="dropdown-header">Filter</h6>
										<a class="dropdown-item" href="#">Sales</a> <a
											class="dropdown-item" href="#">Purchases</a> <a
											class="dropdown-item" href="#">Returns</a>
									</div>
								</div>
								<div class="dropdown mr-3 d-none d-md-block">
									<button
								...
								<button class="btn btn-primary btn-sm mr-3 d-none d-md-block">Download
									Report</button>
								<button
									class="btn btn-outline-primary btn-sm  d-none d-md-block">Data
									Export</button>
							</div>
						</div>
						<div
							class="d-md-flex align-items-center justify-content-between flex-wrap">
							<div class="d-flex align-items-center">
								<p class="mb-0 font-weight-medium mr-2 d-none d-md-block">Categories
									:</p>
							...
							<div class="d-flex mt-3 mt-lg-0">
								<div class="d-none d-md-flex">
									...
									<div class="d-flex align-items-center mr-3">
										...
										<p class="mb-0 ml-1 text-dark cursor-pointer">Plans &
											billing</p>
									</div>
									<div class="d-flex align-items-center mr-3">
					...
					<div class="row">
						<div class="col-xl-8 grid-margin stretch-card">
							<div class="card recent-revenue-card">
								<div class="card-body">
									...
									<p class="mb-4 text-muted">Thes are your most revenue
										generating customers in the given period. engage them with a
										special campaign.</p>
									<div class="row">
										<div class="col-md-12">
											<div class="flot-wrapper">
												<div id="recentRevenueChart" class="flot-chart"></div>
											</div>
											<div class="more-info">
												<div>
													<span>Change</span><span>$6.52</span>
												</div>
												<div>
													<span>Market Cap</span><span>$0.11T</span>
												</div>
												<div>
													<span>Supply</span><span>17,355,513</span>
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-4">
											<div
												...
												<i
													class="mdi mdi-flag-variant-outline icon-md mr-3 text-info"></i>
												<div>
						...
						<div class="col-xl-4 grid-margin stretch-card">
							<div class="row flex-grow w-100">
								<div
									class="col-md-6 col-xl-12 grid-margin-md-0 grid-margin-xl grid-margin stretch-card">
									<div class="card dashboard-special-card">
										<img src="adminResources/image/oval.svg" class="oval"
											alt="oval"> <img
											src="adminResources/image/rectangle.svg" class="rectangle"
											alt="rectangle">
										<div class="card-body text-white">
											<div class="row mt-3">
												<div class="col-md-6">
													<!-- <h4 class="text-white font-weight-bold">Your business</h4> -->
													<h4 class="text-white font-weight-bold mb-3">Your
														business in our hands</h4>
													<button class="btn btn-sm text-white">Upgrade
														Trail</button>
												</div>
												<div class="col-md-6 mt-3 mt-md-0">
													<img src="adminResources/image/card-img.svg" alt="">
												</div>
											</div>
											<div class="mt-2 mb-5 mb-md-2 card-bottom">
												<p class="tx-13 mb-0">Best for small business</p>
												<p class="tx-13 mb-0">Accessible on mobile & esktop
													devices</p>
											</div>
										</div>
									</div>
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<p class="mb-3 text-muted">Measures your user's sessions
										and page views metrics to your website.</p>
										...
										<div class="col-sm-4 col-md-5 mg-t-30 mg-sm-t-0">
											<ul class="list-unstyled">
												<li class="d-flex align-items-center"><span
													class="d-inline-block p-1 bg-purple mr-3"></span> Very
													Satisfied (26%)</li>
												<li class="d-flex align-items-center"><span
													class="d-inline-block p-1 bg-primary mr-3"></span>
													Satisfied (39%)</li>
												<li class="d-flex align-items-center"><span
													class="d-inline-block p-1 bg-teal mr-3"></span> Not
													Satisfied (20%)</li>
												<li class="d-flex align-items-center"><span
													class="d-inline-block p-1 bg-gray mr-3"></span> Satisfied
													(15%)</li>
											</ul>
										</div>
									</div>
						...
						<div class="col-md-6 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<p class="mb-0 text-muted">Measures your user's sessions
										and page views metrics to your website for this month.</p>
								...
								<div class="row">
									<div class="col-md-4 stretch-card">
										<div class="card-body">
											...
											<p class="mb-3 text-muted">The top locations where users
												of your product are located for this month</p>
											<div>
												<div class="d-flex justify-content-between mt-2">
													<span>United States</span> <span
														class="tx-12 font-weight-bold">3,564</span>
												</div>
												...
												<div class="d-flex justify-content-between mt-3">
													<span>United Kingdom</span> <span
														class="tx-12 font-weight-bold">7,567</span>
												</div>
												<div class="progress progress-sm mt-2">
												...
												<div class="d-flex justify-content-between mt-3">
													<span>Russia</span> <span class="tx-12 font-weight-bold">6,466</span>
												</div>
												<div class="progress progress-sm mt-2">
													<div class="progress-bar" role="progressbar"
														style="width: 75%" aria-valuenow="55" aria-valuemin="0"
														aria-valuemax="100"></div>
												</div>
												<div class="d-flex justify-content-between mt-3">
													<span>China</span> <span class="tx-12 font-weight-bold">5,234</span>
												</div>
												<div class="progress progress-sm mt-2">
												...
												<div class="d-flex justify-content-between mt-3">
													<span>Australia</span> <span class="tx-12 font-weight-bold">4,865</span>
												</div>
												<div class="progress progress-sm mt-2">
													<div class="progress-bar bg-teal" role="progressbar"
														style="width: 55%" aria-valuenow="85" aria-valuemin="0"
														aria-valuemax="100"></div>
												</div>
											</div>
										</div>
						...
						<div class="col-xl-3 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<p class="mb-3 text-muted">The percentage of users who uses
										mobile devices compare to other devices.</p>
					...
					<div class="row">
						<div class="col-xl-4 grid-margin grid-margin-md-0 stretch-card">
							<div class="row">
								<div class="col-md-6 col-xl-12 stretch-card grid-margin">
									<div class="card">
										<div class="card-body">
											...
											<p class="tx-12 mb-3 text-muted">Tells you where your
												visitors originated from, such as search engines, social
												networks or website referrals.</p>
											<div class="row">
								...
								<div
									class="col-md-6 col-xl-12 grid-margin-md grid-margin-xl-0 stretch-card">
									<div class="card">
										<div class="card-body">
											<h6 class="card-title">Sessions</h6>
											<p class="tx-12 mb-3 text-muted">A session is the period
												time a user is actively engaged with your website, app, etc.</p>
											<div class="row">
												<div class="col-6 d-sm-flex align-items-center">
													...
													<div>
														<label class="tx-12 mb-1 mt-2 mt-md-0">New
															Sessions</label>
						...
						<div class="col-xl-8 stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<p class="mb-2 text-muted">Part of this date range occurs
										before the new users metric had been calculated, so the old
										users metric is displayed.</p>
